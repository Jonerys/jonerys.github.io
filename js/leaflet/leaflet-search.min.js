...
!function(a) {
    ...
    return a.Control.Search = a.Control.extend({
        ...
        onAdd: function(b) {
            ...
            this._buttonGroup = this._createButtonGroup(),
            this._cancel = this._createCancel(this.options.textCancel, "search-cancel"),
            this._button = this._createButton(this.options.textPlaceholder, "search-button"),
            this._alert = this._createAlert("search-alert"),
            this.options.collapsed === !1 && this.expand(this.options.collapsed),
            this.options.marker && (this.options.marker instanceof a.Marker || this.options.marker instanceof a.CircleMarker ? this._markerSearch = this.options.marker : this._isObject(this.options.marker) && (this._markerSearch = new a.Control.Search.Marker([0, 0],this.options.marker)),
        ...
        showAlert: function(a) {
            /*var b = this;
            return a = a || this.options.textErr,
        ...
        collapseDelayed: function() {
            var a = this;
            return this.options.autoCollapse ? (clearTimeout(this.timerCollapse),
        ...
        _createInput: function(b, c) {
            ...
            e.value = b,
            a.DomEvent.disableClickPropagation(f).on(f, "keyup", this._handleKeypress, this).on(f, "paste", function(a) {
                setTimeout(function(a) {
                    d._handleKeypress(a)
                }, 10, a)
            }, this).on(f, "blur", this.collapseDelayed, this).on(f, "focus", this.collapseDelayedStop, this),
            f
        },
        _createButtonGroup: function() {
            return a.DomUtil.create("div", "search-button-group", this._container);
        },
        _createCancel: function(b, c) {
            var d = a.DomUtil.create("a", c, this._container.children[3]);
            return d.href = "#",
            d.title = b,
        ...
        _createTooltip: function(b) {
            ...
            a.DomEvent.disableClickPropagation(d).on(d, "blur", this.collapseDelayed, this).on(d, "mousewheel", function(b) {
        ...
        _createTip: function(b, c) {
            ...
            if (this.options.buildTip) {
                ...
                m = a.DomUtil.create("img", "search-tip-icon");
                m.setAttribute('src', icons.find(i => i.type == c.layer.feature.icontype).icon_x1.options.iconUrl);
                d.innerHTML = m.outerHTML + b;
        ...
        _searchInLayer: function(b, c, d) {
            ...
            e.layer = b,
            c[f._getPath(b.options, d)] = e) : f._getPath(b.feature.properties, d) && (e = b.getLatLng(),
            e.layer = b,
            c[f._getPath(b.feature.properties, d)] = e) : b instanceof a.Path || b instanceof a.Polyline || b instanceof a.Polygon ? f._getPath(b.options, d) ? (e = b.getBounds().getCenter(),
            e.layer = b,
            c[f._getPath(b.options, d)] = e) : f._getPath(b.feature.properties, d) && (e = b.getBounds().getCenter(),
            e.layer = b,
            c[f._getPath(b.feature.properties, d)] = e) : b.hasOwnProperty("feature") ? b.feature.properties.hasOwnProperty(d) && (b.getLatLng && "function" == typeof b.getLatLng ? (e = b.getLatLng(),
            e.layer = b,
            c[b.feature.properties[d]] = e) : b.getBounds && "function" == typeof b.getBounds && (e = b.getBounds().getCenter(),
            e.layer = b,
            c[b.feature.properties[d]] = e)) : b instanceof a.LayerGroup && b.eachLayer(function(a) {
        ...
        _handleKeypress: function(a) {
            ...
            default:
                ...
                this._input.value.length ? this._cancel.style.visibility = "visible" : this._cancel.style.visibility = "hidden",
                this._input.value.length >= this.options.minLength ? (clearTimeout(this.timerKeypress),
        ...
        _fillRecordsCache: function() {
            var b, c = this, d = this._input.value;
        ...
        _handleAutoresize: function() {
            var a;
            this._input.style.maxWidth !== this._map._container.offsetWidth && (a = this._map._container.clientWidth,
            a -= 83,
