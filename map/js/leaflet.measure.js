...
var ravenDay=Math.round(totalRound/170)/10
var dragonDay=Math.round(totalRound/45)/10
var armyDay=Math.round(totalRound/25)
...
text+=' км.</div>'
text+='Ворон: '+ravenDay+' дн.</div>'
text+='Дракон: '+dragonDay+' дн.</div>'
text+='Пехота: '+armyDay+' дн.</div>'
